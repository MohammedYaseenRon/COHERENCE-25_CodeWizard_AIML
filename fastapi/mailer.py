...
if __name__ == "__main__":
    # Example candidate profile (can be any schema)
    candidate_profile = {
        "name": "John Doe",
    ...
    # Example job description (can be any format)
    job_description = {
        ...
        "available_projects": [
            {
                ...
                "description": "Develop ML model to predict customer churn",
                "required_skills": ["Python", "Machine Learning", "Pandas"],
                "duration": "6 weeks"
            },
            {
                "name": "Data Warehouse Optimization",
                "description": "Optimize ETL processes for faster analytics",
    ...
    company_info = {
        ...
        "contact_email": "hr@datainsights.com",
        "website": "www.datainsights.com"
    }
    
    # Initialize and use the email generator
    ...
    success = email_gen.send_assignment_email(
        sender_email="anuragma807@gmail.com",
        receiver_email="usmanimohammed12@gmail.com",
        password="obpemoxtnsadpgdf",
    ...
    if success:
        print("Project assignment email sent successfully!")
    else:
        print("Failed to send project assignment email")