        ...
        <div className="bg-[#1b2537] p-6 rounded-lg">
            ...
            <div className="flex flex-col space-y-4">
                <div
                    ...
                    className="border-2 border-dashed border-blue-500 rounded-lg p-6 text-center cursor-pointer hover:bg-[#2c3646] transition-colors mb-4"
                >
                    <Upload className="mx-auto mb-4 text-blue-500" size={40} />
                    <p className="text-gray-400">Drag and drop your resume here</p>
